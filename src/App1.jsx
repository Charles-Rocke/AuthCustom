    ...
    <>
      <div className="container d-flex">
        ...
        <div className="container">
          ...
          <AuthList authObject={options} onPasskeyClick={handlePasskeyClick} onGoogleClick={handleGoogleClick}/>
        </div>
        <CodeBlock domCode={domCode} />
        {/* Display Card Section */}
        <div className="container">
          <Card passkeyActive={passkeyActive} googleActive={googleActive} options={options} />
        </div>
				{/* Display Card Section */}
        <div className="container">
          <UserCard />
